...
class Rental_tb extends Model {
    ...
    protected $fillable = ['User_id','Bg_id','Rental_cost','rental_days','daily_rate','rented_at','due_at','returned_at','Rental_status'];
    protected $casts = ['rented_at'=>'datetime','due_at'=>'datetime','returned_at'=>'datetime'];
    protected $appends = ['is_overdue', 'overdue_days'];
